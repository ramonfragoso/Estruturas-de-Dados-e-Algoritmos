...
public class HashtableClosedAddressImpl<T> extends AbstractHashtableClosedAddress<T> {
   ...
   public static void main(String[] args) {
	   ...
	   HashtableClosedAddressImpl<Integer> x = new HashtableClosedAddressImpl<Integer>(5, HashFunctionClosedAddressMethod.DIVISION);
	   System.out.println(x.getPrimeAbove(123123));
   }
